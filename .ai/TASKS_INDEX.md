...
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-EXPANSION-001** | `PROVISIONAL_BLOCKED` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex + Michał/operator | Operator-assisted rozszerzenie real-camera fixture dla dalszej walidacji offline | 2026-06-04 | BLOCKED_BY_OPERATOR_CAPTURE; WAITING_FOR_NEW_REAL_CAMERA_CAPTURE; no benchmark before review pack approval |
