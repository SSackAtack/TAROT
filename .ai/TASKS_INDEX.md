...
| **TASK-CV-OFFLINE-LAB-STAGE-1-DIFF-BENCHMARK-001** | `DONE` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Offline benchmark Stage 1 Difference Detection na zatwierdzonych fixture | 2026-06-03 | Benchmark complete; recommended gray_absdiff_gaussian |
