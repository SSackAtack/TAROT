...
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-REVERSED-WRONG-DECK-001** | `DONE` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Offline tooling i operator-assisted real-camera fixture Stage 6: upright, reversed, wrong deck, YELLOW i visually similar | 2026-06-04 | Physical capture complete: 28 manually confirmed samples, preflight PASS, manual review pack ready; no runtime integration |
