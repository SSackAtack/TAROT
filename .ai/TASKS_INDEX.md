...
| **TASK-CV-STAGE-6-REAL-CAMERA-QUALITY-GATE-BENCHMARK-001** | `APPROVED` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Offline benchmark quality gate z highlight masks i retry decisions | 2026-06-04 | APPROVED_OFFLINE_QUALITY_GATE_BENCHMARK_ONLY; BENCHMARK_HEURISTIC_ONLY; no runtime threshold or integration approval |
| **TASK-CV-STAGE-6-REAL-CAMERA-QUALITY-GATE-APPROVAL-DOC-001** | `DONE` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Dokumentacyjne utrwalenie decyzji Supervisora dla quality gate benchmark | 2026-06-04 | APPROVED_OFFLINE_QUALITY_GATE_BENCHMARK_ONLY recorded; documentation-only |
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-EXPANSION-001** | `APPROVED` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex + Michał/operator | Minimalna 8-próbkowa paczka RWS na jasnej macie dla dalszej walidacji offline | 2026-06-04 | APPROVED_RWS_EXPANSION_FIXTURE_OFFLINE_ONLY_BY_CHATGPT_SUPERVISOR |
| **TASK-CV-STAGE-6-RWS-WIZARD-HANDOFF-FIX-001** | `DONE` | `task/cv-stage-6-rws-wizard-handoff-fix-001` | Gemini | Doprowadzenie commita cc6d4df do stanu bezpiecznego do przejęcia po Codexie | 2026-06-04 | Local tests passed; wizard launcher camera pid check fixed |
| **TASK-CV-STAGE-6-RWS-EXPANSION-BENCHMARK-001** | `APPROVED` | `task/cv-stage-6-rws-expansion-benchmark-001` | Gemini | Uruchomienie offline benchmarku rozpoznawania kart ORB na minimalnym fixture RWS | 2026-06-04 | APPROVED_OFFLINE_RWS_EXPANSION_BENCHMARK_ONLY; no runtime integration; no runtime threshold approval |
| **TASK-CV-STAGE-6-RWS-EXPANSION-BENCHMARK-APPROVAL-DOC-001** | `DONE` | `task/cv-stage-6-rws-expansion-benchmark-001` | Gemini | Dokumentacyjne utrwalenie decyzji zatwierdzającej dla benchmarku RWS | 2026-06-04 | APPROVED_OFFLINE_RWS_EXPANSION_BENCHMARK_ONLY recorded; documentation-only |
| **TASK-CV-STAGE-6-RWS-BENCHMARK-ROBUSTNESS-FIX-001** | `APPROVED` | `task/cv-stage-6-rws-expansion-benchmark-001` | Gemini | Zwiększenie odporności i uściślenie raportowania offline benchmarku RWS | 2026-06-04 | APPROVED_OFFLINE_RWS_BENCHMARK_ROBUSTNESS_FIX_ONLY; no runtime integration; no runtime threshold approval |
| **TASK-CV-STAGE-6-RWS-BENCHMARK-ROBUSTNESS-FIX-APPROVAL-DOC-001** | `DONE` | `task/cv-stage-6-rws-expansion-benchmark-001` | Gemini | Dokumentacyjne utrwalenie decyzji zatwierdzającej dla poprawki odporności benchmarku RWS | 2026-06-04 | APPROVED_OFFLINE_RWS_BENCHMARK_ROBUSTNESS_FIX_ONLY recorded; documentation-only |
| **TASK-CV-STAGE-6-RWS-RUNTIME-POLICY-DESIGN-001** | `DONE` | `task/cv-stage-6-rws-expansion-benchmark-001` | Gemini | Projektowanie zachowania runtime / panelu operatora dla RWS Stage 6 | 2026-06-04 | Offline-only runtime/operator policy design; no runtime implementation; PENDING_SUPERVISOR_REVIEW |
