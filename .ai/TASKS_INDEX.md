...
| **TASK-CV-STAGE-6-RWS-AUTOTUNE-RUNTIME-COMMANDS-001** | `DONE` | `task/cv-stage-6-rws-autotune-runtime-commands` | Gemini | Wdrożenie szkieletu komend WebSocket Autotune w runtime (etap 2 PR-F) | 2026-06-05 | Testy targeted i backend suite OK, smoke test PASS |
