...
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-EXPANSION-001** | `PROVISIONAL_ACCEPTED_FOR_MANUAL_REVIEW` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex + Michał/operator | Minimalna 8-próbkowa paczka RWS na jasnej macie dla dalszej walidacji offline | 2026-06-04 | Manual review pack ZIP prepared (SHA-256 A5BEF393...); WAITING_FOR_SUPERVISOR_MANUAL_REVIEW |
