...
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-REVERSED-WRONG-DECK-001** | `TODO` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Offline tooling i operator-assisted real-camera fixture Stage 6: upright, reversed, wrong deck, YELLOW i visually similar | 2026-06-04 | Plan ready; pending Supervisor plan review; physical capture required; no runtime integration |
