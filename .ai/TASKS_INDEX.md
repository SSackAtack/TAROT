...
| **TASK-CV-DIAG-001** | `DONE` | `master` (Read-only) | Gemini | Diagnostyka błędu rozpoznawania kart po wdrożeniu launchera | 2026-05-31 | Zweryfikowano podwójną przyczynę (ArUco + talia Boski) |
