...
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-REVERSED-WRONG-DECK-001** | `PROVISIONAL_BLOCKED` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Offline tooling i operator-assisted real-camera fixture Stage 6: upright, reversed, wrong deck, YELLOW i visually similar | 2026-06-04 | Phase A offline tooling complete; blocked pending minimum 28 physical manually confirmed sessions; no runtime integration |
