...
| **TASK-CV-STAGE-6-REAL-CAMERA-FIXTURE-EXPANSION-001** | `PROVISIONAL_BLOCKED` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex + Michał/operator | Minimalna 8-próbkowa paczka RWS na jasnej macie dla dalszej walidacji offline | 2026-06-04 | Corrected default launcher: RWS identify expansion 1/8; isolated worktree ready; BLOCKED_BY_OPERATOR_CAPTURE |
