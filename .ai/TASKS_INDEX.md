...
| **TASK-CV-STAGE-6-CALIBRATION-WIZARD-LIVE-CAMERA-SMOKE-001** | `DONE` | `task/cv-stage-6-calibration-wizard-live-camera-smoke-001` | Gemini | Live smoke test Asystenta Kalibracji z fizyczną kamerą | 2026-06-05 | FAILED_WITH_BLOCKER |
...
| **TASK-CV-STAGE-6-CALIBRATION-WIZARD-SCENARIO-BUTTONS-FIX-001** | `DONE` | `task/cv-stage-6-calibration-wizard-scenario-buttons-fix-001` | Gemini | Naprawa przycisków startu w stanie gotowej rekomendacji | 2026-06-05 | Awaiting ChatGPT Supervisor review |
