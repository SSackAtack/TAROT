...
| **TASK-CV-STAGE-6-RWS-BENCHMARK-ROBUSTNESS-FIX-001** | `DONE` | `task/cv-stage-6-rws-expansion-benchmark-001` | Gemini | Zwiększenie odporności i uściślenie raportowania offline benchmarku RWS | 2026-06-04 | PENDING_SUPERVISOR_REVIEW |
