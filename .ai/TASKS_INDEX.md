...
| **TASK-CV-STAGE-6-REAL-CAMERA-QUALITY-GATE-DESIGN-001** | `DONE` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Projekt offline-only quality gate i retry dla Stage 6 real-camera | 2026-06-04 | Design ready; existing Stage 5 metrics do not separate 3 glare failures; pending Supervisor review |
