...
| **TASK-CV-OFFLINE-LAB-STAGE-6-SYNTHETIC-VALIDATION-BENCHMARK-001** | `TODO` | `task/cv-event-first-plan-001-clarify-autotune-runtime` | Codex | Deterministyczny synthetic validation benchmark Stage 6: ORB vs AKAZE, reversed i wrong deck | 2026-06-04 | Plan ready; pending Supervisor plan review; no runtime integration |
