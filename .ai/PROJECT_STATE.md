...
* **TASK-CV-RECT-001 (Parametryzacja detekcji prostokątów kart):** parametryzacja detekcji prostokątów kart pod autotuning. Odizolowane wyprowadzenie parametrów Canny, area ratio, contour mode (external, list, tree) oraz max_candidates z twardych stałych przy zachowaniu kompatybilności. Zweryfikowane syntetycznym testem zagnieżdżenia A4. **[APPROVED BY CHATGPT SUPERVISOR (PR #11)]**
